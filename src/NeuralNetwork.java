...
class NeuralNetwork {
    private static InputLayer n1;
    private static InputLayer n2;
    private static HiddenLayer n3;
    private static HiddenLayer n4;
    private static OutputLayer n5;
    private static InputLayer bias1;
    private static HiddenLayer bias2;
    ...
    void initializeNeuralNetwork() {
        ...
        n4 = new HiddenLayer();
        n5 = new OutputLayer();
        bias1 = new InputLayer();
        bias2 = new HiddenLayer();
        n1.setWeight1(0.33);
        n1.setWeight2(0.42);
        n2.setWeight1(0.5);
        n2.setWeight2(-0.17);
    ...
    public static void main(String[] args) {
        ...
        neural.initializeNeuralNetwork();
        ...
        //for 1 epoch
        try {
            FileReader fr = new FileReader(".\\src\\dataset.txt");
